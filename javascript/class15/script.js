...
// //memory leak se bachne ke leaye ye kar do kya kar do closer object ko null initialize kar do
// user1Upload = null;
// user2Upload = null;
...
// });
// console.log(prom);
// let x=prom.then((res)=>{console.log("Promis is resolve :",res)}).catch((e)=>{console.log("Promis is reject :",e);
// })
...
// console.log(x);
// let ans=[];
// x.then((ans)=>(ans.json())).then((data)=>{console.log(data)})
